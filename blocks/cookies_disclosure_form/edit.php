        ...
        <div class="ccm-block-field-group">
            <div class="input">
                <ul class="inputs-list">
                    <li><label><?php echo $form->checkbox('showCheckbox', 1,
                                $showCheckbox == 1) ?><?php echo t('Show Checkbox') ?></label></li>
                    <li><label><?php echo $form->checkbox('ajaxSubmit', 1,
                                $ajaxSubmit == 1) ?><?php echo t('AJAX Submit') ?></label></li>
                </ul>
            </div>
        </div>
        <div class="ccm-block-field-group">
