...
class CookiesDisclosureFormBlockController extends BlockController {
	...
	public function view() {
		if ($this->ajaxSubmit || $this->get('ajaxSubmit')) {
			...
			$this->addHeaderItem($html->javascript(Loader::helper('concrete/urls')->getToolsUrl('disclosure_i18n_js', 'free_cookies_disclosure')));
