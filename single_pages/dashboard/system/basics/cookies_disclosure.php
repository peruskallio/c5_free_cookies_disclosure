    ...
    <div class="ccm-pane-body">
        <fieldset>
            ...
            <div class="clearfix">
                ...
                <div class="input">
                    <?php echo $form->select('alignment',
                        array('top' => t('Top of the Page'), 'bottom' => t('Bottom of the Page')), $alignment); ?>
                </div>
            </div>
            <div class="clearfix">
                ...
                <div class="options options-custom">
                    <div class="clearfix">
                        ...
                        <div class="input">
                            ...
                            <span
                                class="help-inline"><?php echo t("CSS file named cookies_disclosure_SUFFIX.css will be loaded from your {root}/css directory.") ?></span>
                        </div>
                    </div>
                </div>
            </div>
            <div class="clearfix">
                ...
                <div class="input">
                    ...
                    <span
                        class="help-inline"><?php echo t("In seconds (leave empty if you don't want to hide the notification)") ?></span>
                </div>
            </div>
        </fieldset>
        <fieldset>
            ...
            <div class="clearfix">
                <div class="input">
                    <ul class="inputs-list">
                        <li><label><?php echo $form->checkbox('debug', 1, $debug == 1) ?>
                                <span><?php echo t('Enable Debug Mode') ?></span></label></li>
                    </ul>
                    <div class="help-block">
                        <?php echo t("When debug mode is enabled, the notification is visible although user would've already allowed cookies.") ?>
                        <br/>
        ...
        <div class="clearfix">
            ...
            <?php if ($hasMultilingual) : ?>
                <p><?php echo t('If you want to customize the notification message, just create a stack for each language named: "%s" and add your content there.',
                        t('Cookies Disclosure - LANG')) ?></p>
            ...
            <?php else : ?>
                <p><?php echo t('If you want to customize the notification message, just create a stack named "%s" and add your content there.',
                        t('Cookies Disclosure')) ?></p>
            <?php endif; ?>
